...
<div class="toc"><ul class="toc-item"><li><span><a href="#Requirements" data-toc-modified-id="Requirements-1">Requirements</a></span></li><li><span><a href="#Directory-Tree" data-toc-modified-id="Directory-Tree-2">Directory Tree</a></span></li><li><span><a href="#Data" data-toc-modified-id="Data-3">Data</a></span><ul class="toc-item"><li><span><a href="#1.-Pollution-Data" data-toc-modified-id="1.-Pollution-Data-3.1">1. Pollution Data</a></span></li><li><span><a href="#2.-Weather-Data" data-toc-modified-id="2.-Weather-Data-3.2">2. Weather Data</a></span></li></ul></li></ul></div>
...
## 1. Pollution Data 
    ...
    - Berkeley project provides historical PM2.5 data back until late 2016 http://berkeleyearth.org/
    - Alternative sources: https://aqicn.org/ : only provide daily average data PM2.5, PM10, SO2 ! 
